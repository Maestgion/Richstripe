    ...
    <>
      <div className="h-[90vh] flex flex-col justify-center items-center gap-8">
        <div className="flex flex-col gap-8 text-white text-center w-[100%]">
            ...
            <p className="text-lg">
            Ready to watch? Create an account to  create or restart your membership.
            </p>
        </div>
        ...
        <div>
           ...
           <Link to="/signup">
           <button className="outline-none rounded-md bg-[#004E96] text-white hover:bg-[#023c72] py-4 px-10 font-bold text-2xl">
              Get Started
            </button>
           </Link>
          </div>
